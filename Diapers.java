...
public class Diapers extends ForChildren {
    ...
    public String toString(){
        return String.format("Наименование: %s; Цена: %d; Количество: %d; Единица измерения: %s; минимальный возраст:  %d; Гипоаллургенность: %s; Размер: %d; Мин. вес: %d; Макс. вес: %d; Тип: %s",
